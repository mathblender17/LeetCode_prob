...
public:
/**
was a little tricky but got the hang of it 
1. to check th pre- requisite conditions - small letter , capital letter, number
2. check for the number to be inserted if <6  or removed,replaced >20 
3. check for the number of tripets
return the max of number of insertions needed , number triplets to be removed , no of conditiond left to be met yet 
**/
